...
<footer class="footer">
    <div class="container">
		...
		s13.8,22.1,13.8,37.9C290.55,259.2,284.85,276.6,273.55,291.9z" />
                    ...
                    <a href="mailto:info@veresk.org" target="_blank" class="support-email mx-3">
                        info@veresk.org
                    </a>
...
<script src="<?php bloginfo('template_directory')?>/js/script.min.js?v=1562504812865"></script>
